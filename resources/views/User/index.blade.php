...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
  ...
  <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
    <div>
        ...
        <p class="text-slate-500">A list of all the user data..</p>
    </div>
    <div class="ml-3">
    ...
    <table class="w-full text-left table-auto min-w-max">
      <thead>
        <tr>
          ...
          <th class="p-4 border-b border-slate-200 bg-slate-50">
            <p class="text-sm font-normal leading-none text-slate-500">User ID</p>
          </th>
          <th class="p-4 border-b border-slate-200 bg-slate-50">
            <p class="text-sm font-normal leading-none text-slate-500">Name</p>
          </th>
          <th class="p-4 border-b border-slate-200 bg-slate-50">
            <p class="text-sm font-normal leading-none text-slate-500">Username</p>
          </th>
          <th class="p-4 border-b border-slate-200 bg-slate-50">
            <p class="text-sm font-normal leading-none text-slate-500">Password</p>
          </th>
          <th class="p-4 border-b border-slate-200 bg-slate-50">
            <p class="text-sm font-normal leading-none text-slate-500">Level</p>
          </th>
          <th class="p-4 border-b border-slate-200 bg-slate-50">
      ...
      <tbody>
        @foreach ($Users as $User)
          <tr class="hover:bg-slate-50 border-b border-slate-200">
            ...
            <td class="p-4 py-5">
              <a href="{{ route('User.edit', $User->id) }}" class="font-medium text-blue-600 hover:text-blue-800">Edit</a>
            </td>
            <td class="p-4 py-5">
