 ...
 <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border px-6 py-6">
   ...
   <form action="{{ route('Stok.update', $Stok->id) }}" method="POST">
     ...
     <div class="border-b border-gray-900/10 pb-12">
       <h2 class="text-base/7 font-semibold text-gray-900">Edit Stock Data</h2>
       <p class="mt-1 text-sm/6 text-gray-600">Update the necessary stock information carefully.</p>


       <div class="mt-10 col-span-full gap-y-8">
         <label for="id_barang" class="block text-sm/6 font-medium text-gray-900">ID Item</label>
         <div class="mt-2">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         ...
         <div class="mt-2">
         <input id="jml_masuk" name="jml_masuk" type="text" value="{{ old('jml_masuk', $Stok->jml_masuk) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
       </div>
     ...
     <div class="mt-5 col-span-full gap-y-8">
         <label for="total_barang" class="block text-sm/6 font-medium text-gray-900">Amount Total</label>
         <div class="mt-2">
