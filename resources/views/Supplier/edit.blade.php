 ...
 <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border px-6 py-6">
   ...
   <form action="{{ route('Supplier.update', $Supplier->id) }}" method="POST">
     ...
     <div class="border-b border-gray-900/10 pb-12">
       ...
       <p class="mt-1 text-sm/6 text-gray-600">Update the necessary supplier information carefully.</p>
       ...
       <div class="mt-10 col-span-full gap-y-8">
         ...
         <div class="mt-2">
           <input id="id_supplier" name="id_supplier" type="text" value="{{ old('id_supplier', $Supplier->id_supplier) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" readonly>  
         </div>
       </div>
